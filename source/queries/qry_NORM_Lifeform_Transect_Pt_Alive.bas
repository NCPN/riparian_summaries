dbMemo "SQL" ="SELECT Unit_Code, Stream_Name, Visit_Year, Plot_ID, Transect, Lifeform_Type, Tra"
    ...
    "ORM_Point_Cover_Species_Lifeform WHERE Is_Alive = 1 AND Lifeform IS NOT NULL ORD"
    "ER BY Unit_Code, Stream_Name, Plot_ID, Transect, Lifeform)  AS t0\015\012WHERE 1"
    "=1\015\012GROUP BY Unit_Code, Stream_Name, Visit_Year, Plot_ID, Transect, Transe"
    "ct_Point_Lifeform, Lifeform_Type\015\012ORDER BY Plot_ID, Transect;\015\012"
dbMemo "Connect" =""
