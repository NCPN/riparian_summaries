dbMemo "SQL" ="SELECT DISTINCT Unit_Code, Stream_Name, Visit_Year, Plot_ID, Transect, Lifeform_"
    ...
    "oint_Lifeform,\015\012Lifeform, Duration\015\012FROM qry_NORM_Point_Cover_GL_Lif"
    "eform\015\012WHERE\015\012Lifeform IS NOT NULL\015\012ORDER BY \015\012Unit_Code"
    ", Stream_Name, Plot_ID, Transect, Lifeform\015\012)  AS t0\015\012WHERE 1=1\015\012"
    "GROUP BY Unit_Code, Stream_Name, Visit_Year, Plot_ID, Transect, Transect_Point_L"
    "ifeform, Lifeform_Type\015\012ORDER BY Plot_ID, Transect;\015\012"
dbMemo "Connect" =""
