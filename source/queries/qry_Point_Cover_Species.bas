Operation =1
Option =0
Where ="(((tbl_LP_Intercept.Point) Is Not Null))"
Begin InputTables
    Name ="tbl_Locations"
    Name ="tbl_Events"
...
dbMemo "Filter" ="((([qry_Point_Cover_Species].[Visit_Year]=2011) AND ([qry_Point_Cover_Species].["
    "Plot_ID]=1) AND ([qry_Point_Cover_Species].[Unit_Code]=\"ZION\"))) AND ([qry_Poi"
    "nt_Cover_Species].[Stream_Name] Is Not Null AND [qry_Point_Cover_Species].[Strea"
    "m_Name]<>\"\")"
